...
class DefaultController extends Controller
{
    ...
    {
        $product = new RentProd();
        $form = $this->createForm('RentProductsBundle\Form\RentProdType', $product);
        $user = $this->container->get('security.token_storage')->getToken()->getUser();
        ...
        return $this->render('@RentProducts/Default/newProduct.html.twig', array(
            'product' => $product,
            'form' => $form->createView()
        ));
    }
    public function ReadAction(Request $request)
    {
        ...
        return $this->render('@RentProducts/Default/showProdcut.html.twig', array(
            'products' => $pagination
        ));
    }
